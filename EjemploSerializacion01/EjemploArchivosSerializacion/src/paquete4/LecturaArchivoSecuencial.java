...
public class LecturaArchivoSecuencial {
    ...
    public String toString() {
        ...
        for (int i = 0; i < obtenerListaHospitales().size(); i++) {
            cadena = String.format("%s(%d) Nombre: %s - Camas: %d - "
                    + "Presupuesto: %.2f\n", cadena,
                    i + 1,
                    obtenerListaHospitales().get(i).obtenerNombre(),
                    obtenerListaHospitales().get(i).obtenerNumeroCamas(),
                    obtenerListaHospitales().get(i).obtenerPesupuesto());
        }
